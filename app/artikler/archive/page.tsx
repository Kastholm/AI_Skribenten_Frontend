...
export default function ArchivePage() {
  ...
  const [view, setView] = useState<"table" | "cards">("table") // Default to table for archive
  ...
  // Dummy functions for ArticleCard compatibility (not used in archive)
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage>Archive {activeSite && `- ${activeSite.name}`}</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
